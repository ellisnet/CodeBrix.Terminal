...
#pragma warning restore CS0169 // Field is never used
    ...
    public void CursorUp (int rows)
    {
        ...
        // When the cursor starts outside the scroll region (above or below),
        // CUU moves it up to the top of the screen.
        if (buffer.Y < top || buffer.Y > buffer.ScrollBottom) {
            top = 0;
        }
    ...
    public void CursorDown (int rows)
    {
        ...
        // When the cursor starts outside the scroll region (above or below),
        // CUD moves it down to the bottom of the screen.
        if (buffer.Y < buffer.ScrollTop || buffer.Y > bottom) {
