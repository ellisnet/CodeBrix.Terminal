...
public partial class Unicode {
    ...
    /// <remarks><para>There are static properties that can be used to fetch a specific category, or you can use the <see cref="M:CodeBrix.Terminal.Text.Unicode.Category.Get"/> method this class to retrieve the RangeTable by its Unicode category table name</para></remarks>
...
// DO NOT EDIT
    ...
    /// <remarks><para>There are static properties that can be used to fetch a specific category, or you can use the <see cref="T:CodeBrix.Terminal.Text.Unicode.Script.Get"/> method in this class to retrieve the range table by its script name</para></remarks>
...
// DO NOT EDIT
    ...
    /// <remarks><para>There are static properties that can be used to fetch RangeTables that identify characters that have a specific property, or you can use the <see cref="T:CodeBrix.Terminal.Text.Unicode.Property.Get"/> method in this class to retrieve the range table by the property name</para></remarks>
