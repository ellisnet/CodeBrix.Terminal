...
// ReSharper disable RedundantFixedPointerDeclaration
...
///    <see cref="M:CodeBrix.Terminal.Text.Unicode.IsUpper"/>, <see cref="M:CodeBrix.Terminal.Text.Unicode.IsLower"/>, <see cref="M:CodeBrix.Terminal.Text.Unicode.IsDigit"/>,
///    <see cref="M:CodeBrix.Terminal.Text.Unicode.IsGraphic"/> to convert runes from one case to another using the <see cref="M:CodeBrix.Terminal.Text.Unicode.ToUpper"/>,
///    <see cref="M:CodeBrix.Terminal.Text.Unicode.ToLower"/>, <see cref="M:CodeBrix.Terminal.Text.Unicode.ToTitle"/> as well as various constants
