...
/// 
/// </remarks>
public abstract class ustring : IComparable<ustring>, IComparable, IConvertible, IEnumerable<uint>, IEquatable<ustring>, ICloneable
{
    ...
    /// <summary>
    /// Returns a slice of the string with all leading and trailing space characters removed (as determined by <see cref="M:CodeBrix.Terminal.Text.Unicode.IsSpace()"/> 
    /// </summary>
