...
public partial struct Rune {
    ...
    static AcceptRange [] AcceptRanges =
    [
    ...
    public static bool IsDigit (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsDigit (rune.value);
    ...
    /// </remarks>
    public static bool IsGraphic (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsGraphic (rune.value);
    ...
    /// </remarks>
    public static bool IsPrint (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsPrint (rune.value);
    ...
    /// </remarks>
    public static bool IsControl (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsControl (rune.value);
    ...
    /// <remarks>
    /// </remarks>
    public static bool IsLetter (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsLetter (rune.value);
    ...
    /// <remarks>
    /// </remarks>
    public static bool IsLetterOrDigit (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsLetter (rune.value) || CodeBrix.Terminal.Text.Unicode.IsDigit (rune.value);
    ...
    /// <remarks>
    /// </remarks>
    public static bool IsLetterOrNumber (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsLetter (rune.value) || CodeBrix.Terminal.Text.Unicode.IsNumber (rune.value);
    ...
    /// </remarks>
    public static bool IsMark (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsMark (rune.value);
    ...
    /// </remarks>
    public static bool IsNumber (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsNumber (rune.value);
    ...
    /// </remarks>
    public static bool IsPunctuation (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsPunct (rune.value);
    ...
    /// </remarks>
    public static bool IsWhiteSpace (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsSpace (rune.value);
    ...
    /// <returns><c>true</c>, if the rune is a mark, <c>false</c> otherwise.</returns>
    /// <param name="rune">The rune to test for.</param>
    public static bool IsSymbol (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsSymbol (rune.value);
    ...
    /// <param name="rune">The rune to test for.</param>
    public static bool IsUpper (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsUpper (rune.value);
    ...
    /// <returns><c>true</c>, if the rune is a lower case letter, <c>false</c> otherwise.</returns>
    /// <param name="rune">The rune to test for.</param>
    public static bool IsLower (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsLower (rune.value);
    ...
    /// <returns><c>true</c>, if the rune is a lower case letter, <c>false</c> otherwise.</returns>
    /// <param name="rune">The rune to test for.</param>
    public static bool IsTitle (Rune rune) => CodeBrix.Terminal.Text.Unicode.IsTitle (rune.value);
    ...
    public static Rune To (Case toCase, Rune rune)
    {
        ...
        switch (toCase) {
            case Case.Lower:
                return new Rune (CodeBrix.Terminal.Text.Unicode.To (CodeBrix.Terminal.Text.Unicode.Case.Lower, rval));
            case Case.Title:
                return new Rune (CodeBrix.Terminal.Text.Unicode.To (CodeBrix.Terminal.Text.Unicode.Case.Title, rval));
            case Case.Upper:
                return new Rune (CodeBrix.Terminal.Text.Unicode.To (CodeBrix.Terminal.Text.Unicode.Case.Upper, rval));
        }
    ...
    public static Rune ToUpper (Rune rune) => CodeBrix.Terminal.Text.Unicode.ToUpper (rune.value);
    ...
    /// <param name="rune">Rune.</param>
    public static Rune ToLower (Rune rune) => CodeBrix.Terminal.Text.Unicode.ToLower (rune.value);
    ...
    /// <returns>The lower cased rune if it can be.</returns>
    /// <param name="rune">Rune.</param>
    public static Rune ToTitle (Rune rune) => CodeBrix.Terminal.Text.Unicode.ToTitle (rune.value);
    ...
    /// </code>
    /// </remarks>
    public static Rune SimpleFold (Rune rune) => CodeBrix.Terminal.Text.Unicode.SimpleFold (rune.value);
    ...
    public override string ToString ()
    {
        ...
        return Text.Encoding.UTF8.GetString (buff, 0, size);
    }
