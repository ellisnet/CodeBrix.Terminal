================================================================================
README-INDEX: CodeBrix.Terminal
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Terminal.MitLicenseForever -- in-memory VT100/VT220/xterm
      terminal emulation engine, escape-sequence parser, buffer and
      scrollback, input encoding and Unicode text utilities.
